...
\documentclass[forprint,fontset=windows]{SUDAProject}
\usepackage{fontspec}
\usepackage{xpatch}
\usepackage{xeCJK}
\usepackage{fancyhdr}
...
\title{苏州大学本科毕业论文~\LaTeX~模板}%文章标题
\author{张三}                            % 作者名字
\Csupervisor{XXX}        %指导教师中文名
\ProfessionalTitle{教授}    %指导教师职称
\Cmajor{电气工程及其自动化}                  % 专业中文名
\Cschoolname{机电工程学院}          % 学院名
\Grade{4年级}             %年级
\Class{2班}               %班级
\date{二〇二三年五月}               % 日期
\maketitle
\pagenumbering{roman}    %设置正文前页码为小写罗马数字
...
\tableofcontents
\mainmatter 
\pagenumbering{arabic}%% 设置正文页码为阿拉伯数字
\chapter{先说重要的}
...
本模板修改自武汉大学黄正华教授模板.已获得黄教授授权. 本文档正文部分绝大部分为武汉大学模板内容,本文档下载更新地址: \url{https://github.com/Xuan423/LaTeX-template-Soochow-University./tree/main}. 使用之前, 请移步查看是否有更新.

问题反馈及建议, 请联系: xuanli2004@foxmail.com.
...
\section{更新记录}
2023年06月更新: 更新使其适配苏州大学毕业设计模板格式, 感谢黄教授等的信赖与授权公开.
...
上文使用的源文件为:
 ...
 %{\kaishu 关于此问题, 请参见文献~\verb|\cite{r2}|. 作者某某还提到了某某概念~\verb|\upcite{r1}|.}
